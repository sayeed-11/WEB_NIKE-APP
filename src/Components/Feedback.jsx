...
const Feedback = () => {
    return (
        <div className='relative bg-slate-100 w-full py-10 md:py-20'>
            ...
            <h1 className='font-nike text-[1.5rem] md:text-[2.5rem] font-bold italic pl-5 sm:pl-10 lg:px-20'><span>CUSTOMER'S</span> <span className='text-yellow-500 text-[2rem] md:text-[3rem]'>FEEDBACK</span></h1>
                    ...
                    feedbacks.map((fb, i) => {
                        return (
                            <div key={fb.id} className='min-w-[250px] flex flex-col justify-between gap-y-5 bg-white rounded-lg overflow-hidden shadow-md mr-3'>
                                <p className='bg-black rounded-ee-[6rem] h-[100%] p-2 border-b-4 border-yellow-500 shadow-xl '>
                                    <span className='text-yellow-500 font-nike italic scale-[5]'>"</span>
                                    <span className='text-sm  text-white font-text font-semibold'>{fb.feedback}</span>
                                    <span className='text-yellow-500 font-nike italic'>"</span>
                                </p>
                                <div className='flex items-center gap-x-5 p-3'>
                                    <div className='bg-yellow-500 rounded-full p-[1.5px] shadow-md'>
