...
const HomePage = () => {
    ...
    return (
        <div className='w-full lg:min-h-screen bg-black flex lg:flex-row flex-col-reverse overflow-x-hidden'>
            <div className='w-full bg-slate-100 lg:w-[66.66%] pt-20 flex flex-col justify-center px-5 sm:px-20 space-y-5 pb-40 relative'>
                <div>
                    <div className='flex items-baseline gap-x-3'>
                        ...
                        <h1 className='font-nike text-xl sm:text-4xl text-yellow-500'>Design & Quality</h1>
                    </div>
            ...
            <div className='w-[100%] h-auto lg:w-[33.33%] bg-black relative flex justify-end lg:justify-center items-center py-20 sm:py-10 md:py-16  lg:py-0 px-10 lg:px-0'>
                <h1 className='text-[7rem] sm:text-[12rem] lg:text-[15rem] text-zinc-900 lg:-rotate-90 font-nike italic translate-y-10 font-bold'>NIKE</h1>
                ...
                <div className='w-full absolute h-20 -bottom-1 sm:-bottom-2 lg:bottom-0 overflow-hidden -left-1'>
                    <div className='triangle h-full w-[30%] bg-slate-100'></div>
                </div>
