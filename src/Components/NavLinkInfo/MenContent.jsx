...
const MenContent = ({ height }) => {
    // console.log(height);
    return (
        <div className={`bg-white w-screen right-100 absolute top-[56px] overflow-hidden ${height ? "h-auto lg:h-[400px]" : "h-0"} max-w-[1350px] left-0 transition-all hidden md:grid grid-cols-3 lg:grid-cols-5 font-nike text-black`}>
